...
$__jsHelp = array(
	...
	'date' => 'Choisissez ici la date à étudier, au format AAAA-MM-JJ. Si vous avez peu de données, il peut être intéressant d\'étendre l\'étude sur plusieurs jours : remplissez le 2e champ pour cela.',
	'heatmap' => 'Choix du format d\'affichage: position des clics (par défaut, très rapide, les clics gauches sont en rouge, les clics droits en vert), ou sous forme d\'une carte de température (plus lent, clics gauches seulement)',
