...
define('LANG_JAVASCRIPT_GROUP2', 'use o títuloda página web (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">não recomendado</a>)');
define('LANG_JAVASCRIPT_GROUP3', 'use a URL da página web (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">não recomendado</a>)');
...
define('LANG_CONFIG_MEMORY', 'Limite de memória (valor default do php.ini: %dMB, limites: de %d até %dMB, mas <a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">cuidado com valores altos</a>)');
