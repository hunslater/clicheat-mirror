...
define('LANG_HEATMAP', 'Карта (полупрозрачная)');
define('LANG_LATEST_CHECK', 'Обновить');
define('LANG_LATEST_KO', 'Невозможно найти последнюю доступную версию. Вы можете посмотреть ее на сайте:');
define('LANG_LATEST_OK', 'У вас самая последняя версия (%s)');
define('LANG_LATEST_NO', 'Ваша версия (%s) устарела, новая: (%s). Вы можете скачать новую версию на вашем сайте:');
...
define('LANG_JAVASCRIPT_PAGE', 'Имя группы, для группировки сходных страниц с целью упрощения анализа');
define('LANG_JAVASCRIPT_PAGE1', 'использовать ключевое слово (замените <span class="error">ABC</span> вашим ключевым словом, допустимые символы: A-Z, 0-9, символ подчеркивания, дефис)');
define('LANG_JAVASCRIPT_PAGE2', 'использовать заголовок страницы (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">не рекомендуется</a>)');
define('LANG_JAVASCRIPT_PAGE3', 'использовать адрес страницы (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">не рекомендуется</a>)');
define('LANG_JAVASCRIPT_PASTE', 'Скопируйте и вставьте нижеследующий код в конец ваших страниц (перед &lt;/body&gt; тегом):');
...
//define('LANG_NO_CLICK_BELOW', 'Не было зафиксировано ни одного клика ниже этой линии');
define('LANG_ERROR_GROUP', 'Неизвестная группа. _JAVASCRIPT_');
define('LANG_ERROR_DATA', 'Нет данных за выбранный период. _JAVASCRIPT_');
...
define('LANG_ERROR_MEMORY', 'Лимит памяти недоступен в ini_get(), пожалуйста, проверьте config.php');
...
define('LANG_CHECKS', 'Предварительный проверки');
define('LANG_CHECK_WRITABLE', 'Права на запись в директорию конфигурации');
define('LANG_CHECK_NOT_WRITABLE', 'PHP не имеет прав на запись в директорию конфигурации. Это не проблема, но так было бы проще изменять установки.');
...
define('LANG_CONFIG_LOGPATH_MKDIR', 'Невозможно создать директорию логов, пожалуйста, создайте ее самостоятельно и дайте права на запись в нее для PHP');
define('LANG_CONFIG_CHECK', 'Проверить установки');
define('LANG_CONFIG_MEMORY', 'Лимит памяти (в MB)');
define('LANG_CONFIG_MEMORY_KO', 'Вы должны задать ненулевой лимит памяти, если Вы сомневаетесь, задайте 8. В php.ini установлено:');
...
define('LANG_CONFIG_DL', 'Нет прав на запись в директорию конфигурации, пожалуйста, сохраните файл установок в директорию "/config/"');
define('LANG_CONFIG_DOWNLOAD', 'Загрузить файл с установками');
